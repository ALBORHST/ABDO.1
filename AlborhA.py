...
os.system('am start https://www.facebook.com/adel.guma')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/adel.guma")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/HSAsS8Dt").text
...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/adel.guma/?ref=share')
os.system('xdg-open https://www.facebook.com/adel.guma/?ref=share')
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m    𝙰 𝙱 𝙳 𝙾   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m 𝙰 𝙱 𝙳 𝙾  \033[0;m]")
    print(f"")
    linex()
